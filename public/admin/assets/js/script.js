		...
		'<li class="sidebar-icons">' +
			'<a class="toggle tipinfo open-layout open-siderbar" href="javascript:void(0);" data-toggle="tooltip" data-placement="left" data-bs-original-title="Tooltip on left">' +
				'<div class="tooltip-five ">' +
					'<img src="{{asset('/')}}admin/assets/img/icons/siderbar-icon2.svg" class="feather-five" alt="">' +
					...
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<div class="sidebar-logo">' +
							'<a href="index" class="logo">' +
								'<img src="{{asset('/')}}admin/assets/img/logo.png" alt="Logo" class="img-flex">' +
							'</a>' +
						'</div>' +
					'</div>' +
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="{{asset('/')}}admin/assets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
					'</div>' +
				'</div>' +
			'</div>' +
		'</div>' +
			...
			'<div class="row align-items-center">' +
				...
				'<div class="col-xl-12 col-sm-6 col-12">' +
					'<div class="sidebar-image align-center">' +
						'<img class="img-fliud" src="{{asset('/')}}admin/assets/img/demo-one.png" alt="demo">' +
					'</div>' +
					'<div class="row">' +
...
// 						'<img src="{{asset('/')}}admin/assets/img/icons/sidebar-icon-01.svg" class="feather-five" alt="">' +
// 					'</a>' +
// 				'</li>' +
// 				'<li class="sidebar-icons">' +
// 					'<a href="#" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
// 						'<img src="{{asset('/')}}admin/assets/img/icons/sidebar-icon-02.svg" class="feather-five" alt="">' +
// 					'</a>' +
// 				'</li>' +
// 				'<li class="sidebar-icons">' +
...
//                         '<img src="{{asset('/')}}admin/assets/img/icons/close-icon.svg" alt=""></a>' +
// 				'</div>' +
// 				'<div class="sidebar-body">' +
// 					'<h6 class="theme-title">Choose Mode</h6>' +
// 					'<div class="switch-wrapper">' +
// 						'<div id="dark-mode-toggle">' +
// 							'<span class="light-mode active"> <img src="{{asset('/')}}admin/assets/img/icons/sun-icon.svg" class="me-2" alt=""> Light</span>' +
...
// 									'<img class="img-fliud" src="{{asset('/')}}admin/assets/img/layout-ltr.png" alt="layout">' +
// 								'</div>' +
// 							'</div>' +
// 						'</div>' +
// 						'<div class="col-xl-6 ere">' +
...
// 								'</div>' +
// 								'<div class="layout-img">' +
// 									'<img class="img-fliud" src="" alt="layout">' +
// 								'</div>' +
// 							'</div>' +
// 						'</div>' +
// 					'</div>' +
...
// 								'</div>' +
// 								'<div class="layout-img">' +
// 									'<img class="img-fliud" src="{{asset('/')}}admin/assets/img/layout-04.png" alt="layout">' +
// 								'</div>' +
// 							'</div>' +
// 						'</div>' +
// 						'<div class="col-xl-6 ere">' +
...
// 								'</div>' +
// 							 	'<div class="layout-img">' +
// 									 '<img class="img-fliud" src="{{asset('/')}}admin/assets/img/layout-01.png" alt="layout">' +
// 							 	'</div>' +
// 						 	'</div>' +
// 						'</div>' +
// 					'</div>' +
...
// 				 	'<a class="sidebar-close" href="#"><img src="{{asset('/')}}admin/assets/img/icons/close-icon.svg" alt=""></a>' +
// 				'</div>' +
// 			 	'<div class="sidebar-body">' +
...
// 								'</div>' +
// 								'<div class="layout-img">' +
// 									'<img class="img-fliud" src="{{asset('/')}}admin/assets/img/layout-03.png" alt="layout">' +
// 								'</div>' +
// 							'</div>' +
// 						'</div>' +
// 						'<div class="col-xl-6 ere">' +
