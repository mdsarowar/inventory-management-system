                ...
                <ul class=" tabs owl-carousel owl-theme owl-product  border-0 " >
                    <li class="active" id="fruits">
                        <div class="product-details " >
                            <img src="{{asset('/')}}admin/assets/img/product/product62.png" alt="img">
                            <h6>Fruits</h6>
                        </div>
                    </li>
                    <li id="headphone">
                        <div class="product-details " >
                            <img src="{{asset('/')}}admin/assets/img/product/product63.png" alt="img">
                            <h6>Headphones</h6>
                        </div>
                    </li>
                    <li id="Accessories">
                        <div class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product64.png" alt="img">
                            <h6>Accessories</h6>
                        </div>
                    </li>
                    <li id="Shoes">
                        <a class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product65.png" alt="img">
                            <h6>Shoes</h6>
                        </a>
                    </li>
                    <li id="computer">
                        <a class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product66.png" alt="img">
                            <h6>Computer</h6>
                        </a>
                    </li>
                    <li id="Snacks">
                        <a class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product67.png" alt="img">
                            <h6>Snacks</h6>
                        </a>
                    </li>
                    <li id="watch">
                        <a class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product68.png" alt="img">
                            <h6>Watches</h6>
                        </a>
                    </li>
                    <li id="cycle">
                        <a class="product-details">
                            <img src="{{asset('/')}}admin/assets/img/product/product61.png" alt="img">
                            <h6>Cycles</h6>
                        </a>
                    </li>
                    <li id="fruits1">
                    ...
                    <div class="tab_content" data-tab="Accessories">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product32.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product46.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product55.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="Shoes">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product60.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="computer">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product56.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="Snacks">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product47.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product48.png" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product57.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product58.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="watch">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product49.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product51.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                    </div>
                                    <div class="productsetcontent">
                                        <h4>Watch</h4>
                    ...
                    <div class="tab_content" data-tab="cycle">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product52.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{asset('/')}}admin/assets/img/product/product53.jpg" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
...
{{--                                        </select>--}}
                            ...
                            <div class="col-12">
                                <div class="text-end">
                                    <a class="btn btn-scanner-set"><img src="{{asset('/')}}admin/assets/img/icons/scanner1.svg" alt="img" class="me-2">Scan bardcode</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @php
                      $products=  session()->get('purches_item',[]);
                      $amount=  session()->get('amount_data')
                    @endphp
                    <div class="card-body pt-0" id="test_load">
                        <div class="totalitem">
                            <h4 >Total items :
                                <input id="total_item" class="border-0" type="text" value="{{isset($amount)?$amount['total_item']:''}}" readonly>
                            </h4>
                            <a href="javascript:void(0);">Clear all</a>
                        </div>
                        <div class="product-table" id="dy_product">
                            @if(isset($products))
                                @foreach($products as $key=> $product)
                                    <ul class="product-lists" id="ul{{$product['product_id']}}">
                                        <li>
...
{{--                                                            <input type="button" value="-"  class="button-mi dec button">--}}
                                                            <input type="text" class="form-control w-50 quantity-field" value="{{$product['product_qty']}}" data-id="{{$product['product_id']}}" aria-describedby="emailHelp" placeholder="quntaty">
{{--                                                            <input type="text" name="child"  value="{{$product['product_qty']}}" class="quantity-field product_qty" >--}}
{{--                                                            <input type="button" value="+"  class="button-pl inc button ">--}}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
{{--                                        <form action="{{route('delete_select_product',$product['product_id'])}}" method="POST" class="sr-dl" >--}}
{{--                                            @csrf--}}
{{--                                            @method('delete')--}}
                                            <a class="btn_remove" id="{{$product['product_id']}}" href="javascript:void(0);">
                                                <img src="{{asset('/')}}admin/assets/img/icons/delete.svg" alt="img">
                                            </a>
{{--                                        </form>--}}
{{--                                        <li><a class="delete_confirm confirm-text" href="javascript:void(0);"><img src="{{asset('/')}}admin/assets/img/icons/delete-2.svg" alt="img"></a></li>--}}
                                    </ul>
                                @endforeach
                            @endif
...
{{--                                    <div class="productimg">--}}
{{--                                        <div class="productimgs">--}}
{{--                                            <img src="{{asset('/')}}admin/assets/img/product/product34.jpg" alt="img">--}}
{{--                                        </div>--}}
{{--                                        <div class="productcontet">--}}
{{--                                            <h4>Green Nike--}}
...
{{--                                </li>--}}
{{--                                <li>3000.00	</li>--}}
{{--                                <li><a class="confirm-text" href="javascript:void(0);"><img src="{{asset('/')}}admin/assets/img/icons/delete-2.svg" alt="img"></a></li>--}}
{{--                            </ul>--}}
                    ...
                    <div class="card-body pt-0 pb-2">
                        <div class="setvalue">
                            <ul>
                                <li>
                                    <h5>Subtotal </h5>
                                    <h6 id="total_taka">{{isset($amount)?$amount['total_taka']:''}}</h6>
                                </li>
                                <li>
                                    <h5>Tax </h5>
                                    <h6>5.00$</h6>
                        ...
                        <div class="btn-pos">
                            <ul>
                                <li>
                                    <a class="btn"><img src="{{asset('/')}}admin/assets/img/icons/pause1.svg" alt="img" class="me-1">Hold</a>
                                </li>
                                <li>
                                    <a class="btn"><img src="{{asset('/')}}admin/assets/img/icons/edit-6.svg" alt="img" class="me-1">Quotation</a>
                                </li>
                                <li>
                                    <a class="btn"><img src="{{asset('/')}}admin/assets/img/icons/trash12.svg" alt="img" class="me-1">Void</a>
                                </li>
                                <li>
                                    <a class="btn"><img src="{{asset('/')}}admin/assets/img/icons/wallet1.svg" alt="img" class="me-1">Payment</a>
                                </li>
                                <li>
                                    <a class="btn"  data-bs-toggle="modal" data-bs-target="#recents"><img src="{{asset('/')}}admin/assets/img/icons/transcation.svg" alt="img" class="me-1"> Transaction</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="calculator-set">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-closes"><img src="{{asset('/')}}admin/assets/img/icons/close-circle.svg" alt="img"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">0</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="btn btn-reverse"><img src="{{asset('/')}}admin/assets/img/icons/reverse.svg" alt="img"></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="delete-order">
                        <img src="{{asset('/')}}admin/assets/img/icons/close-circle1.svg" alt="img">
                    </div>
    ...
    <script>
        $(document).ready(function(){
            $("[id*=product_id]").on('click',function (){
                ...
                if($(this).hasClass('active') === false){
                    $.ajax({
                        url:base_url+'/get_product/'+product_id,
                        type:'get',
                        dataType:'json',
        ...
        $(document).on('click','.btn_remove',function (){
            ...
            Swal.fire({
                ...
                if (t.value == true) {
                    $.ajax({
                        url:base_url+'/delete_select_product/'+button_id,
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        type:'delete',
                        dataType:'json',
                        success:function (){
                            $('#ul'+button_id+'').remove();
                            toastr.success('your product item delete');
                        }
                    });
                }
            });
        ...
        $(document).on('change','.quantity-field',function(){
            ...
            $.ajax({
                url:base_url+'/pro_qty_change/'+id,
                type:'get',
                dataType:'json',
                data:{
                    'qty':id_val,
