...
{{--                </div>--}}
            ...
            <div class="page-btn">
                <a href="{{ url('roles/create') }}" class="btn btn-added">
                    <img src="{{asset('/')}}admin/assets/img/icons/plus.svg" alt="img" class="me-2">Add Role</a>
            </div>
        </div>
...
{{--                            <th>email</th>--}}
                        ...
                        @foreach ($roles as $role)
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('update role')
                                        <a class="btn btn-warning" href="{{ url('roles/'.$role->id.'/give-permissions') }}">
