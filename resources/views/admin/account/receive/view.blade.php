...
@section('title',__('Received Voucher View'))
@section('custom_css')
    <style>
        /* invoice print */
        img.invoice_logo {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="d-flex flex-column align-items-end">
                                            <h2 class="text-dark mb-2 mt-md-2">{{__('Invoice')}} #{{$receive->inv_number}}</h2>
                                            <ul class="list list-unstyled mb-0">
                                                <li>{{__('Date:')}} <span id="invoice_modal_date">{{$receive->date}}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="text-center">{{__('RECEIPT VOUCHER')}}</h3>
                                        <hr>
                                    </div>
                                </div>
                                    ...
                                    <table class="table text-center">
                                        ...
                                        @foreach($details as $detail)
                                            @php
                                                ...
                                                $sup = explode("-", $detail->received_form);
                                               if (isset($sup[1])) {
                                                    if ($sup[0] == 'sup') {
