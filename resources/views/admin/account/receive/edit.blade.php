                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="revvoucher_no" name="voucher_no" value="{{$receive->inv_number}}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="form-group">
                                <label>{{__('Date')}}</label>
                                <input type="date" id="revvoucher_date" name="date" class="form-control" value="{{ \Carbon\Carbon::parse($receive->date)->format('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
