...
@section('title',__('Create New Payment Voucher'))
@section('custom_css')
    <style>
    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>{{__('Payment Voucher Add')}}</h4>
                <h6>{{__('Create New Payment Voucher')}}</h6>
            </div>
        </div>
        <!-- /add -->
        <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="voucher_no" name="voucher_no" value="{{$formattedNumber}}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="form-group">
                                <label>{{__('Date')}}</label>
                                <input type="date" id="voucher_date" name="date" class="form-control" value="{{$date}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <label>{{__('Payment Source')}}</label>
                                <select name="pay_soruch" id="pay_soruch" class="form-select" >
                                    <option value="" selected disabled>-- select one --</option> <!-- No value attribute -->
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="tel" name="balance" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
...
$(document).ready(function() {
    ...
    //     const select = document.getElementById('pay_soruch');
    //     if (select.value === '') {
